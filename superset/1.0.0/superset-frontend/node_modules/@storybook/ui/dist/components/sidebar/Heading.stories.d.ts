...
export declare const customBrandImageTall: () => JSX.Element;
export declare const customBrandImageUnsizedSVG: () => JSX.Element;
export declare const noBrand: () => JSX.Element;
