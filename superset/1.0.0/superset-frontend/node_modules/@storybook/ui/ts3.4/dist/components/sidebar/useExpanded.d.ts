...
export declare const useExpanded: ({ containerRef, isBrowsing, refId, data, rootIds, highlightedRef, setHighlightedItemId, selectedStoryId, onSelectStoryId, }: ExpandedProps) => [
