...
export declare const Code: ({ className, ...props }: React.ComponentProps<typeof DefaultCodeBlock>) => JSX.Element;
...
export declare const components: {
    ...
    code: ({ className, ...props }: React.ComponentProps<typeof DefaultCodeBlock>) => JSX.Element;
