...
class TTestTable extends React.Component {
  ...
  render() {
    ...
    return ___EmotionJSX("div", null, ___EmotionJSX("h3", null, metric), ___EmotionJSX(Table, {
      className: "table",
      id: `table_${metric}`,
      sortable: sortConfig
    }, ___EmotionJSX(Thead, null, columns), rows));
  }
