...
exports.default = exports.dataPropType = void 0;
...
const dataPropType = _propTypes.default.arrayOf(_propTypes.default.shape({
  group: _propTypes.default.arrayOf(_propTypes.default.string),
...
exports.dataPropType = dataPropType;
const propTypes = {
  ...
  metric: _propTypes.default.string.isRequired,
...
class TTestTable extends _react.default.Component {
  constructor(props) {
    super(props);
    this.state = {
      control: 0,
  ...
  computePValue(values, control) {
    ...
    try {
      return (2 * new _distributions.default.Studentt(finiteCount - 1).cdf(tvalue)).toFixed(pValPrec); // two-sided test
    } catch (error) {
      return NaN;
    }
  }
  ...
  render() {
    ...
    const columns = groups.map((group, i) => (0, _react2.jsx)(_reactable.Th, {
      key: i,
      column: group
    }, group));
    const numGroups = groups.length; // Columns for p-value, lift-value, and significance (true/false)

    columns.push((0, _react2.jsx)(_reactable.Th, {
      key: numGroups + 1,
      column: "pValue"
    }, "p-value"));
    columns.push((0, _react2.jsx)(_reactable.Th, {
    ...
    const rows = data.map((entry, i) => {
      ...
      (0, _react2.jsx)(_reactable.Td, {
        key: j,
        column: group,
        data: entry.group[j]
      }));
      values.push((0, _react2.jsx)(_reactable.Td, {
        key: numGroups + 1,
      ...
      return (0, _react2.jsx)(_reactable.Tr, {
        key: i,
    ...
    return (0, _react2.jsx)("div", null, (0, _react2.jsx)("h3", null, metric), (0, _react2.jsx)(_reactable.Table, {
      className: "table",
      id: `table_${metric}`,
      sortable: sortConfig
    }, (0, _react2.jsx)(_reactable.Thead, null, columns), rows));
  }
