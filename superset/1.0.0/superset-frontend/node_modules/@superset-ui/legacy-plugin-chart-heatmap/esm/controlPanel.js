...
import { columnChoices, formatSelectOptions, formatSelectOptionsForRange, sections } from '@superset-ui/chart-controls';
  ...
  controlPanelSections: [sections.legacyRegularTime, {
    ...
    controlSetRows: [['linear_color_scheme'], [{
      ...
      config: {
        ...
        default: 'pixelated',
        description: t('image-rendering CSS attribute of the canvas object that ' + 'defines how the browser scales up the image')
      }
    }, {
      ...
      config: {
        ...
        default: 'heatmap',
        description: t('Color will be rendered based on a ratio ' + 'of the cell against the sum of across this ' + 'criteria')
      }
    }], [{
      name: 'left_margin',
      config: {
      ...
      config: {
        ...
        renderTrigger: true,
        default: [null, null],
        description: t('Hard value bounds applied for color coding. Is only relevant ' + 'and applied when the normalization is applied against the whole heatmap.')
      }
    }, 'y_axis_format'], [{
      name: 'show_legend',
      config: {
