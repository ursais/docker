...
const metadata = new _core.ChartMetadata({
  ...
  description: '',
  name: (0, _core.t)('Parallel Coordinates'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class ParallelCoordinatesChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactParallelCoordinates'))),
      metadata,
