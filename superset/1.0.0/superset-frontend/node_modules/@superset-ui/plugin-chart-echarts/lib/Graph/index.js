...
class EchartsGraphChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./EchartsGraph'))),
      metadata: new _core.ChartMetadata({
        credits: ['https://echarts.apache.org'],
        name: (0, _core.t)('Graph Chart'),
...
exports.default = EchartsGraphChartPlugin;