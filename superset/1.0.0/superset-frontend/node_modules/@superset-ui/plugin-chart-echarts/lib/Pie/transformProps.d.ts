...
import { EchartsPieChartProps, EchartsPieLabelType, PieChartTransformedProps } from './types';
export declare function formatPieLabel({ params, labelType, numberFormatter, }: {
