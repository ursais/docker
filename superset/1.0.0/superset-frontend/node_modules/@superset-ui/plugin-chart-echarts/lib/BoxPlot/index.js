...
class EchartsBoxPlotChartPlugin extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    super({
      ...
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./EchartsBoxPlot'))),
...
exports.default = EchartsBoxPlotChartPlugin;