...
exports.parseYAxisBound = parseYAxisBound;
exports.parseNumbersList = parseNumbersList;
...
function parseNumbersList(value, delim = ';') {
  ...
  return value.split(delim).map(num => {
    if ((0, _core.validateNumber)(num)) throw new Error('All values must be numeric');
    return Number(num);
  });
}