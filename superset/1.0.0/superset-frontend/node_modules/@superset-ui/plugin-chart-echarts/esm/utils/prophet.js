...
export function rebaseTimeseriesDatum(data) {
  ...
  return data.map(row => {
    ...
    keys.forEach(key => {
      ...
      if (forecastContext.type === ForecastSeriesEnum.ForecastUpper && keys.includes(lowerKey) && value !== null && row[lowerKey] !== null) {
        value -= row[lowerKey];
      }
