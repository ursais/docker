  ...
  controlPanelSections: [sections.legacyRegularTime, {
    ...
    controlSetRows: [[___EmotionJSX("h1", {
      ...
      config: {
        ...
        options: [['orthogonal', t('Orthogonal')], ['radial', t('Radial')]],
      ...
      config: {
        ...
        options: [['LR', t('Left to Right')], ['RL', t('Right to Left')], ['TB', t('Top to Bottom')], ['BT', t('Bottom to Top')]],
      ...
      config: {
        ...
        options: [['left', t('left')], ['top', t('top')], ['right', t('right')], ['bottom', t('bottom')]],
      ...
      config: {
        ...
        options: [['ancestor', t('ancestor')], ['descendant', t('descendant')]],
