...
const metadata = new _core.ChartMetadata({
  ...
  description: '',
  name: (0, _core.t)('Force-directed Graph'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class ForceDirectedChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactForceDirected'))),
      metadata,
