...
const metadata = new _core.ChartMetadata({
  description: '',
  name: (0, _core.t)('Partition Chart'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class PartitionChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactPartition.js'))),
      metadata,
