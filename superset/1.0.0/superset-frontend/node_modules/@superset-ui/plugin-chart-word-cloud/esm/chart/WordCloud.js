...
class WordCloud extends React.PureComponent {
  ...
  generateCloud(encoder, scaleFactor, isValid) {
    ...
    cloudLayout().size([width * scaleFactor, height * scaleFactor]) // clone the data because cloudLayout mutates input
    .words(data.map(d => ({ ...d
  ...
  render() {
    ...
    }, ___EmotionJSX("g", null, words.map(w => ___EmotionJSX("text", {
      key: w.text,
      fontSize: `${w.size}px`,
      fontWeight: w.weight,
      fontFamily: w.font,
