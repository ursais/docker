...
export default class LineChart extends PureComponent {
  constructor(...args) {
    ...
    this.renderChart = dim => {
      ...
      return layout.renderChartWithFrame(chartDim => ___EmotionJSX(WithTooltip, {
        renderTooltip: ({
          datum,
          series
      ...
      }, layout.renderXAxis(), layout.renderYAxis(), this.renderSeries(allSeries), ___EmotionJSX(CrossHair, {
        fullHeight: true,
        showCircle: true,
  ...
  renderSeries(allSeries) {
    const filledSeries = flatMap(allSeries.filter(({
      ...
      return [___EmotionJSX(LinearGradient, {
    ...
    const unfilledSeries = allSeries.filter(({
      fill
    }) => !fill).map(series => ___EmotionJSX(LineSeries, {
      key: series.key,
      seriesKey: series.key,
      interpolation: "linear",
      data: series.values,
