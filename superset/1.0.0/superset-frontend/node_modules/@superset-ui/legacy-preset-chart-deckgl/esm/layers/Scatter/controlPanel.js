  ...
  controlPanelSections: [sections.legacyRegularTime, {
    ...
    controlSetRows: [[pointRadiusFixed, {
      ...
      config: {
        ...
        renderTrigger: true,
        default: 250,
        description: t('Maxium radius size of the circle, in pixels. As the zoom level changes, this ' + 'insures that the circle respects this maximum radius.')
      }
    }], [multiplier, null]]
  }, {
    label: t('Point Color'),
    controlSetRows: [['color_picker', legendPosition], [null, legendFormat], [_extends({}, dimension, {
