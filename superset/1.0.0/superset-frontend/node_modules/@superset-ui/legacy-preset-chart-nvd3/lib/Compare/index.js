...
const metadata = new _core.ChartMetadata({
  ...
  description: (0, _core.t)('A line chart component where you can compare the % change over time'),
  name: (0, _core.t)('Time-series Percent Change'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class CompareChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
