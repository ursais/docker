...
const config = {
  controlPanelSections: [_chartControls.sections.legacyTimeseriesTime, {
    ...
    expanded: true,
    controlSetRows: [['color_scheme', 'label_colors'], [_NVD3Controls.showLegend], [_NVD3Controls.xAxisFormat]]
  }, {
    label: (0, _core.t)('Y Axis 1'),
    expanded: true,
    controlSetRows: [['metric', 'y_axis_format'], [_NVD3Controls.yAxisShowMinmax], [_NVD3Controls.yAxisBounds]]
  }, {
    label: (0, _core.t)('Y Axis 2'),
    expanded: true,
    controlSetRows: [['metric_2', _NVD3Controls.yAxis2Format], [_NVD3Controls.yAxis2ShowMinmax], [_NVD3Controls.yAxis2Bounds]]
  }, {
